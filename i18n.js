...
const translations = {
  zh: {
    ...
    topSitesTabs: "{0} 个页面",
    ghTrendingTitle: "GitHub 本月热门",
    ghLoading: "正在获取榜单…",
    ghError: "榜单加载失败，请检查网络后重试",
    ghRetry: "重试",
    ghNew: "新上榜",
    ghUpdatedAt: "更新于 {0}",
  ...
  en: {
    ...
    ghTrendingTitle: "GitHub Trending This Month",
    ghLoading: "Loading trending repos…",
    ghError: "Failed to load. Check your network and retry",
    ghRetry: "Retry",
    ghNew: "NEW",
    ghUpdatedAt: "Updated {0}",
